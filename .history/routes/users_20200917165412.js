...
// SHOW ADD USER FORM
app.get('/addsomeuser', function (req, res, next) {
...
app.post('/addsomeuser', function (req, res, next) {
...
// SHOW EDIT USER FORM
app.get('/editsomeuser/(:id)', function (req, res, next) {
	req.getConnection(function (error, conn) {
...
app.put('/editsomeuser/(:id)', function (req, res, next) {
	req.assert('name', 'Name is required').notEmpty()           //Validate name
	req.assert('age', 'Age is required').notEmpty()             //Validate age
	req.assert('email', 'A valid email is required').isEmail()  //Validate email
...
// DELETE USER
app.delete('/deletesomeuser/(:id)', function (req, res, next) {
